    ...
    <tr>
      <td style="padding: 40px 30px;">                
        ...
        <p style="font-size: 16px; margin-bottom: 25px;">
          ...
          <a href="${accountSettingsLink}" style="color: #4a90e2; text-decoration: none;">account settings</a>
...
export interface EmailTemplateEntry {
  label: string;
  generateSubject: (data: GenerateEmailTemplateParams) => string;
  generateBody: (data: GenerateEmailTemplateParams) => string;
}

/**
 * A list of pre-configured reminder emails.
 */
